...
$$
F_\Sigma=\sum_{i=1}^nF_i=\dfrac{n+1}{2}rA
$$
...
E_{i} & =E_{i-1}(1+r)-D\\
 ...
 & =A(1+r)^{i-1}-\sum_{k=1}^{n-1}[D(1+r)^{k-1}]
\end{align*}
$$
...
$$
A(1+r)^{n}-\sum_{i=1}^{n}[D(1+r)^{i-1}]=0
$$

因此，有

$$
D=\dfrac{A(1+r)^{n}}{\sum_{i=1}^{n}(1+r)^{i-1}}=A\dfrac{r(1+r)^{n}}{(1+r)^{n}-1}
$$
...
\begin{align*}
F_{i} & =E_{i}r\\
 & =[A(1+r)^{i-1}-D(1+r)^{i-2}-\cdots-D]r\\
 & =\left\{A(1+r)^{i-1}-\sum_{k=1}^{n-1}[D(1+r)^{k-1}]\right\}r\\
 & =\left\{A(1+r)^{i-1}-D\dfrac{(1+r)^{i-1}-1}{r}\right\}r\\
 & =Ar(1+r)^{i-1}-D[(1+r)^{i-1}-1]
\end{align*}
$$
